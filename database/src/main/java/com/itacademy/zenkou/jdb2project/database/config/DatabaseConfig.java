...
@EnableJpaRepositories(basePackages = "com.itacademy.zenkou.jdb2project.database.repository")
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource, Properties jpaProperties) {
        ...
        factory.setPackagesToScan("com.itacademy.zenkou.jdb2project.database.entity.db");
